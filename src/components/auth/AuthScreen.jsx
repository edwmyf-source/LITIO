      ...
      <section className="flex-shrink-0 md:flex md:items-center md:gap-8">
        <div className="md:flex-1">
          ...
          <h1 className="text-[31px] md:text-[46px] font-extrabold leading-tight" style={{ color: '#134E4A' }}>
            ...
            <span style={{ color: '#1F6E68' }}>de la industria química.</span>
          </h1>
          ...
          <div className="mt-2.5 flex items-center gap-2 flex-wrap">
            ...
            <span className="text-[16px] md:text-[17px] font-bold" style={{ color: '#1F6E68' }}>Comparte</span>
            <span style={{ color: '#C5D9D5', fontSize: 16 }}>·</span>
            <span className="text-[16px] md:text-[17px] font-bold" style={{ color: '#1F6E68' }}>Crece</span>
          </div>
          <button onClick={onSignup}
