  ...
  return (
    <div onClick={skip} style={{
      ...
      <style>{`
        ...
        .cbo-p1 .cbo-e::before { background:linear-gradient(90deg, transparent, #8A8A8A); }
        .cbo-p2 .cbo-e { animation: cbo-spin 2.0s linear infinite; }
        .cbo-p2 .cbo-e::before { background:linear-gradient(90deg, transparent, #2A2A2A); }
        .cbo-p3 .cbo-e { animation: cbo-spin 2.4s linear infinite -0.5s; }
        .cbo-p3 .cbo-e::before { background:linear-gradient(90deg, transparent, #C4C4C4); }
        ...
        .cbo-load {
          ...
          margin-top:22px;
          color:#8A8A8A; font-size:12px; letter-spacing:0.18em;
          font-family: system-ui, -apple-system, sans-serif;
          font-weight:500;
        }
        .cbo-load em {
        ...
        .cbo-load em:nth-child(4) { animation-delay:0.4s; background:#2A2A2A; }
      `}</style>
