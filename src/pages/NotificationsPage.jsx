  ...
  return (
    <div className="page-enter max-w-2xl mx-auto">
      ...
      {loading ? (
        ...
        <div className="bg-white rounded-2xl p-10 text-center" style={{ border: '1px solid #D5D7DA' }}>
          <Bell size={32} className="mx-auto mb-3" style={{ color: '#C2C5C8' }} />
          <p className="text-sm font-medium" style={{ color: '#6E7276' }}>
            Aún no tienes notificaciones de interacciones.
          </p>
          <p className="text-xs mt-1" style={{ color: '#AAAFB4' }}>
                  ...
                  return (
                    <button key={n.id} onClick={() => handleOpen(n)}
                      ...
                      style={{
                        ...
                        borderLeft: isUnread ? '4px solid #0047AB' : '1px solid #D5D7DA',
                      }}>

                      <div className="flex items-center gap-3 px-3 py-3">
                        {/* Avatar con iniciales */}
                        <div className="w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0 text-[13px] font-bold"
                          style={{ background: isUnread ? '#0047AB' : '#EEF0F2', color: isUnread ? '#fff' : '#6E7276' }}>
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="text-[14px] leading-snug" style={{ color: '#0047AB' }}>
                            ...
                            {action && (
                              <span style={{ color: '#6E7276', fontWeight: 400 }}> {action}</span>
                            )}
                          </div>
                          <div className="text-[11px] mt-0.5" style={{ color: '#AAAFB4' }}>
                        ...
                        {isUnread && (
                          <div className="w-2.5 h-2.5 rounded-full flex-shrink-0"
                            style={{ background: '#26282B', boxShadow: '0 0 8px rgba(255,183,3,0.65)' }} />
                        )}
                      </div>
                      ...
                      {snippet && (
                        <div className="mx-3 mb-3 px-3 py-2 rounded-lg text-[12px] leading-relaxed"
                          style={{ background: '#F7F8FA', borderLeft: '3px solid #C2C5C8', color: '#6E7276' }}>
