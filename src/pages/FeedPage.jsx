      ...
      <div className="hidden md:flex gap-4 max-w-5xl mx-auto px-4 pt-4 items-start">
        ...
        <div className="w-52 flex-shrink-0 space-y-3" style={{ position: 'sticky', top: 72 }}>
          ...
          <div className="bg-white rounded-xl overflow-hidden border border-ink-200 shadow-sm">
            ...
            <div className="px-3 pb-3 -mt-6">
              ...
              {profile?.city && <p className="text-[11px] mt-0.5" style={{ color: '#2A6560' }}>{profile.city}</p>}
              <div className="mt-2 pt-2 space-y-1.5" style={{ borderTop: '1px solid #D6E6E3' }}>
                <div className="flex justify-between">
                  <span className="text-[11px]" style={{ color: '#2A6560' }}>Publicaciones</span>
                  <span className="text-[11px] font-bold" style={{ color: '#134E4A' }}>{communityStats.requests || 0}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-[11px]" style={{ color: '#2A6560' }}>Activos hoy</span>
          ...
          <div className="bg-white rounded-xl border border-ink-200 shadow-sm p-3 text-center">
            ...
            <p className="text-[10px] mb-2" style={{ color: '#2A6560' }}>Tu rango aparece en tus posts</p>
              ...
              {[
                ...
                <div key={ev.name} className="flex gap-2 items-start">
                  <div className="w-8 flex-shrink-0 text-center rounded-md py-1" style={{ background: '#F3F6F5', border: '1px solid #C5D9D5' }}>
                    ...
                    <p className="text-[8px] uppercase" style={{ color: '#2A6560' }}>{ev.mon}</p>
                  </div>
                  <div>
                    <p className="text-[10px] font-semibold leading-tight" style={{ color: '#134E4A' }}>{ev.name}</p>
                    <p className="text-[9px]" style={{ color: '#2A6560' }}>{ev.loc}</p>
                  </div>
                </div>
              ))}
        ...
        <div className="flex-1 min-w-0 space-y-3">
          ...
          <div className="flex items-center justify-between">
            <span className="text-[11px]" style={{ color: '#2A6560' }}>
          ...
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center py-16 text-center bg-white rounded-xl border border-ink-200">
              ...
              <p className="text-xs mb-3" style={{ color: '#2A6560' }}>No hay publicaciones que coincidan.</p>
